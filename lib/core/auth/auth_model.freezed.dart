...
/// An UUID string, unique per request.
 String get token;/// Unix time in seconds. It is the time when the token was issued.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthModel&&(identical(other.token, token) || other.token == token)&&(identical(other.issuedAt, issuedAt) || other.issuedAt == issuedAt));
}
...
/// Create a copy of AuthModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? token = null,Object? issuedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String token,  int issuedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthModel() when $default != null:
return $default(_that.token,_that.issuedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String token,  int issuedAt)  $default,) {final _that = this;
switch (_that) {
case _AuthModel():
return $default(_that.token,_that.issuedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String token,  int issuedAt)?  $default,) {final _that = this;
switch (_that) {
case _AuthModel() when $default != null:
return $default(_that.token,_that.issuedAt);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthModel&&(identical(other.token, token) || other.token == token)&&(identical(other.issuedAt, issuedAt) || other.issuedAt == issuedAt));
}
...
/// Create a copy of AuthModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? token = null,Object? issuedAt = null,}) {
